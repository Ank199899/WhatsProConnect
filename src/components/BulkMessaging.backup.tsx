...
import {
  ...
  Parameter as ParameterIcon,
  Argument as ArgumentIcon,
  Input,
  Output,
  Result,
  Outcome,
  ...
  Advantage as AdvantageIcon,
  Disadvantage as DisadvantageIcon,
  Benefit as BenefitIcon,
  Risk,
  Danger,
  Threat,
  Hazard,
  ...
  Chervil,
  Chives,
  Garlic as GarlicChivesIcon,
  Society,
  Onion as OnionChivesIcon,
  Walking,
  Egyptian,
  Tree as TreeOnionIcon,
  Multiplier,
  Potato as PotatoOnionIcon,
  Shallot as ShallotIcon,
  Elephant,
  Rocambole,
  Hardneck,
  Softneck,
  ...
  Marbled,
  Glazed,
  Standard as StandardGarlicIcon,
  Music,
  Red,
  German,
  Extra,
  ...
  Carpathian,
  Polish,
  Hardneck as HardneckIcon,
  Romanian,
  Siberian,
  Korean,
  Purple as PurpleIcon,
  Top,
  Setting,
  Glazed as GlazedIcon,
  Purple as PurpleGlazedIcon,
  ...
  Samarkand,
  Shantung,
  Purple as PurpleShantungIcon,
  Siberian as SiberianIcon,
  Spanish,
  Roja,
  Xian,
  Zemo,
  Imereti,
  Violet as VioletIcon,
  Shatili,
  Pskem,
  River,
  Uzbek,
  ...
  Namangan,
  Andijan,
  Fergana as FerganaIcon,
  Jizzakh,
  Sirdaryo,
  Samarkand as Samarkand2Icon,
  Bukhara as Bukhara2Icon,
  Navoiy,
  Qashqadaryo,
  Surxondaryo,
  Toshkent,
  Namangan as Namangan2Icon,
  Andijon,
  Farg,
  Ona,
  Jizzax,
  Sirdaryo as Sirdaryo2Icon,
  Xorazm,
  Qoraqalpog,
  Iston,
  Respublikasi
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-green-100 p-8 mb-8 relative overflow-hidden">
          ...
          <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-green-200/20 to-transparent rounded-full -translate-y-32 translate-x-32"></div>
